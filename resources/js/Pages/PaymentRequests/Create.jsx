        ...
        <AuthenticatedLayout
            header={
                <PageHeader
                    ...
                    subtitle={`Submitted in your local currency (${currency}); converted to EUR at today's rate.`}
                />
            }
        >
            ...
            <div className="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:px-8">
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mt-6">
                        <InputLabel htmlFor="amount_local" value={`Amount (${currency})`} />
                        <TextInput
                            id="amount_local"
                            type="number"
                            min="0.01"
                            ...
                            onChange={(e) => setData('amount_local', e.target.value)}
                            required
                        />
                    ...
                    <div className="mt-6 rounded-md border border-zinc-200 bg-zinc-50 px-5 py-4 dark:border-zinc-800 dark:bg-zinc-950">
                        {rateError ? (
                            <p className="text-sm text-red-600 dark:text-red-400">
                                Exchange rate service unavailable — you can try again later.
                            </p>
                        ) : !rate ? (
                            ...
                            <div className="flex items-baseline justify-between gap-4">
                                ...
                                <p className="text-right text-xs text-zinc-500 dark:text-zinc-400">
                                    ...
                                    <br />
                                    Final rate is locked at submission.
                                </p>
                            </div>
                        )}
                    </div>
